...
router.get("/get-reservations/:id", async function (req, res, next) {
    const id_business = req.params.id;
    try {
        let reservations = await reservation_db.getReservations(id_business);
